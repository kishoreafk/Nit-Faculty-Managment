...
const signup = async (req, res) => {
  try {
    ...
    const [result] = await pool.execute(
      `INSERT INTO faculty (firstName, lastName, email, password, phone, department, employeeId, facultyType, joiningDate, role, is_approved) 
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'faculty', FALSE)`,
      [firstName, lastName, email, hashedPassword, phone, department, employeeId, facultyType || 'Teaching', joiningDate]
    );
